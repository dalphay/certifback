...
return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array()))->createConnection(array('dbname' => $this->getEnv('MYSQL_DATABASE'), 'host' => $this->getEnv('MYSQL_HOST'), 'port' => 3306, 'user' => $this->getEnv('MYSQL_USER'), 'password' => $this->getEnv('MYSQL_PASSWORD'), 'driver' => 'pdo_mysql', 'charset' => 'utf8mb4', 'driverOptions' => array(), 'serverVersion' => '5.7', 'defaultTableOptions' => array('charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci')), $c, $d, array());
