...
}, 'App\\Repository\\ShoppingCartRepository' => function () {
    return ($this->privates['App\Repository\ShoppingCartRepository'] ?? $this->load('getShoppingCartRepositoryService.php'));
}, 'App\\Repository\\ToBuyRepository' => function () {
    return ($this->privates['App\Repository\ToBuyRepository'] ?? $this->load('getToBuyRepositoryService.php'));
